...
class SynthesisNetwork(nn.Module):
    def __init__(self, alphabet_size: int, hidden_size: int = 400, num_mixtures: int = 20, num_attention_components: int = 10):
        super().__init__()
